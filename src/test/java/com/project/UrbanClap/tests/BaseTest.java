...
//import com.POM.android.pages.AbstractPage;
//import com.POM.android.pages.home.HomeScreen;
//import com.POM.android.pages.login.LoginPage;
...
public class BaseTest {
	...
	private static final String APPLICATION_PACKAGE = "com.urbanclap.urbanclap";
	private static final String APP_ACTIVITY = "com.urbanclap.urbanclap.SplashActivity";
	public static String appiumHost;
	public static String appiumPort;
	public static AndroidDriver<WebElement> driver;
	private JSONObject appConfig;
	private JSONObject appiumConfiguration;
	private JSONObject UrbanClapConfiguration;
	...
	public BaseTest() throws Exception {
		...
		try {
			...
			UrbanClapConfiguration = appConfig.getJSONObject("UrbanClapConfiguration");
	...
	public void loadLoginPage() throws MalformedURLException, JSONException, InterruptedException {
		...
		capabilities.setCapability("app", System.getProperty("user.dir").concat("\\Apps\\UrbanClap\\urbanclap.apk"));
